...
class Config():
    def __init__(self, flexai=False, size=1024, batch_size=4, compile=True) -> None:
        # PATH settings
        ...
        self.compile = compile and (not self.use_fp16)  # 1. Trigger CPU memory leak in some extend, which is an inherent problem of PyTorch.
